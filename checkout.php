...
<section class="checkout-orders">
   ...
   <h3>Your Orders</h3>
      ...
      ?>
         ...
         <div class="grand-total">Your Total : <span>$<?= $grand_total; ?>/-</span></div>
      </div>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>Flat/House No/Floor Level:</span>
            <input type="text" name="flat" placeholder="e.g. Flat Number" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>Area :</span>
            <input type="text" name="street" placeholder="e.g.F.B Area" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>City :</span>
